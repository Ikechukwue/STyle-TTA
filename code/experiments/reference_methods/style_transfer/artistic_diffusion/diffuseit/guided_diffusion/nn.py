...
class CheckpointFunction(th.autograd.Function):
    ...
    def backward(ctx, *output_grads):
        ...
        inputs_and_params = ctx.input_tensors + ctx.input_params
        inputs_requiring_grad = [x for x in inputs_and_params if x.requires_grad]
        ...
        # Reconstruct the full gradient list
        input_grads = []
        grad_iter = iter(computed_grads)
        for x in inputs_and_params:
            if x.requires_grad:
