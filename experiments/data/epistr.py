...
class EpitheliumStroma(VisionDataset):
    ...
    def __init__(self, root_dir: str, split: str, transform: Optional[Callable] = None,
        ...
        """
        Initialize the Epithelium-Stroma dataset.
        ...
        Args:
            ...
            subset_seed (int, optional): Random seed for subset selection.
                Defaults to None.
        """
        super(EpitheliumStroma, self).__init__(root_dir, transform=transform,
    ...
    def _apply_subset(self, subset_size: int,
        ...
        self.dataset = Subset(self.dataset, indices)
        print(f"Using subset of {subset_size} samples from {dataset_size} total "
              f"samples (seed={seed}).")
