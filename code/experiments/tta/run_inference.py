...
from code.config.helpers import inject_stylized_images_inplace
import numpy as np
import torch
...
# TTA baselines
from code.experiments.reference_methods.TTA import GeometricTTA, TENT
...
def run_inference(args: argparse.Namespace) -> Dict[str, float]:
    ...
    if args.style_id:
        ...
        new_dir = str(DATA_PATH / "augmented_cache" / f"dino_{args.dataset}_{args.split}_s71397589")
...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--method_weights", type=str, default=str(WEIGHTS_DIR),
    ...
    p.add_argument("--output_path", type=str, default=str(OUTPUT_PATH))
