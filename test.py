...
if __name__ == "__main__":
    ...
    SUBSET_R_DIR = "/home/stud/nemmler/retristyle/data/imagenet/imagenetabl"

    # Path to your REAL full ImageNet (the one with 1000 classes)
    FULL_IMAGENET_DIR = "/home/stud/nemmler/retristyle/data/imagenet/imagenet1k/ILSVRC/Data/CLS-LOC/train" 

    # Where you want the full ImageNet images for these specific classes to go
    OUTPUT_SUBSET_DIR = "/home/stud/nemmler/retristyle/data/imagenet/imagenet1k/subsets/test_abl"

    # Path to your JSON file
    JSON_PATH = "/home/stud/nemmler/retristyle/data/imagenet/imagenet_subsets.json"
