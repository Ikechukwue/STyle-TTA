...
RESULTS_DIR = OUTPUT_PATH / "domain_gap" / "feature_space" / "test_r"
full = load_json(RESULTS_DIR / "cross_backbone_summary.json")
json_folder = RESULTS_DIR
...
gram_results = RESULTS_DIR / "gram_summary.json"
