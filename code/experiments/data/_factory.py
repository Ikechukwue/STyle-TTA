...
# Import own scripts
from code.experiments.data.camelyon import Camelyon17WILDS
from code.experiments.data.ucmerced import UCMerced
from code.experiments.data.epistr import EpitheliumStroma
from code.experiments.data.peripheral_blood import PeripheralBlood
from code.experiments.data.bone_marrow_smears_and_peripheral_blood import BoneMarrowSmearsAndPeripheralBlood
from code.experiments.data.fitzpatrick import Fitzpatrick17k
from code.experiments.data.ddi import DDI
from code.experiments.data.midog import Midog2022
from code.experiments.data.retina import Retina
#from code.experiments.data.medmnist_dataset import MedMNIST, MEDMNIST_2D_DATASETS
from code.experiments.data.imagefolder import ImageFolder
from code.experiments.data.cifar import CIFAR
from code.experiments.data.eurosat import EuroSAT
...
from code.experiments.data.assets import Assets
