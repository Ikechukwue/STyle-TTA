"""
Base Algorithm class for SDG (Single Domain Generalization) methods.

All SDG algorithms inherit from this base class, which is identical
to the DomainBed base class for consistency.
"""
...
class Algorithm(nn.Module):
    """
    Base class for single domain generalization algorithms.
